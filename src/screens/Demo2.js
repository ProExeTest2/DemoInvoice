...
export default class App extends Component {
  ...
  click_downPdf = async () => {
    ...
    await RNFetchBlob.fetch(
      "GET",
      "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=" + keys,
      {}
    )
      .then((res: any) => {
  ...
  creatpdffile = async () => {
    ...
    const page2 = PDFPage.create().drawText("New page here page2", {
      x: 5,
      y: 480,
      fontSize: 10,
    });
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Button
          title="Download PDF"
          onPress={() => this.click_downPdf()}
        ></Button>

        <Button
          title="Share PDF"
          onPress={() => this.click_sharePdf()}
        ></Button>
      </View>
    );
  }
